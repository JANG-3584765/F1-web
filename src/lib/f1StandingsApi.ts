...
const DRIVER_KR_NAMES: Record<string, string> = {
  ...
  'Andrea Kimi Antonelli':'안드레아 키미 안토넬리',
...
export async function fetchDriverStandings(year: number): Promise<DriverStandingRow[] | null> {
  try {
    const res = await fetch(
      `https://api.jolpi.ca/ergast/f1/${year}/driverStandings.json?limit=200`,
