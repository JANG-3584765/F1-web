...
### 피드백
- **Supabase SQL**: 피드백 의견 수용 공간 수립
- 버그 신고/의견 수용/기타 등의 피드백 의견 분류
- 무분별한 의견 전송을 대비 위한 최소 글자 수 제한
- 필요 시 답장을 받기 위한 이메일 주소 작성 가능 공간
- 무분별한 의견 전송을 대비하기 위해 로그인 시에만 피드백 릐견을 전송할 수 있도록 제한 설립
---
...
- [ ] **로그인**: 구글 로그인 실패(권한 연결 문제 추정) 버그 수정
